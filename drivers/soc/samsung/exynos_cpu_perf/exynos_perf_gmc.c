...
// custom_cl1_freq: freq fixa custom via sysfs
static ssize_t show_custom_cl1_freq(struct kobject *k, struct kobj_attribute *attr, char *buf)
{
    return sprintf(buf, "%u\n", custom_cl1_freq);
}

static ssize_t store_custom_cl1_freq(struct kobject *k, struct kobj_attribute *attr, const char *buf, size_t count)
{
    unsigned int val;
